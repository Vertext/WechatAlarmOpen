...
public class HttpClientUtils {
   ...
   * 获取二维码
   */
  public static String postWXQrcode(String accessToken, String body) throws Exception {
    String url = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=" + accessToken;
    String mimeTyppe = "application/json";
    return post(url, body, mimeTyppe, CHARSET, CONN_TIMEOUT, READ_TIMEOUT);
  }

  public static void postWXMsg(String accessToken, String body) throws Exception {
   ...
   * @throws Exception 其他异常
   */
  public static JSONObject get(String url, String charset, Integer connTimeout, Integer readTimeout)
      throws ConnectTimeoutException, SocketTimeoutException, Exception {
